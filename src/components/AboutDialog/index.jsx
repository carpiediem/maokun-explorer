      ...
      <DialogContent>
        ...
        <p>
          <FormattedMessage
            ...
            values={{
              ...
              a1: externalLink('https://www.history.ucsb.edu/faculty/anthony-barbieri/'),
              ...
              a5: externalLink('http://www1.geo.ntnu.edu.tw/climate/sihsuframe.html'),
              a6: externalLink(
                locale === 'en'
        ...
        <p>
          <FormattedMessage
            id="about.p6"
            values={{
              a7: externalLink('http://ciuhct.org/en/members/jose-manuel-malhao-pereira'),
              a8: externalLink('https://www.ames.cam.ac.uk/people/dr-sally-church'),
