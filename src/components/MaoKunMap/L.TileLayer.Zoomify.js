...
export const TileLayerZoomify = TileLayer.extend({
  options: {
  ...
  _addTile: function(coords, container) {
    ...
    var realTileSize = GridLayer.prototype.getTileSize.call(this),
      displayTileSize = TileLayer.prototype.getTileSize.call(this);
